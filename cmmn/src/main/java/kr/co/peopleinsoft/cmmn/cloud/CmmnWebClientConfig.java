...
@Configuration
@LoadBalancerClients(
	@LoadBalancerClient(name = "default-service", configuration = CmmnLoadbalancerConfig.class)
)
public class CmmnWebClientConfig {

	static final Logger logger = LoggerFactory.getLogger(CmmnWebClientConfig.class);
