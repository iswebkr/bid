...
public class BidPblancListInfoServcPPSSrchJob extends BidPublicInfoController implements Job {
	...
	public BidPblancListInfoServcPPSSrchJob(G2BCmmnService g2BCmmnService, AsyncTaskExecutor asyncTaskExecutor, WebClient publicWebClient, BidPublicInfoService bidPublicInfoService) {
