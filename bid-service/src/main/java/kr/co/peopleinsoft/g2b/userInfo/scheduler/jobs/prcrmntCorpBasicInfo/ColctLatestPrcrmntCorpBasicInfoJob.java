...
public class ColctLatestPrcrmntCorpBasicInfoJob extends PrcrmntCorpBasicInfoController implements Job {
	public ColctLatestPrcrmntCorpBasicInfoJob(G2BCmmnService g2BCmmnService, WebClient publicWebClient, PrcrmntCorpBasicInfoService prcrmntCorpBasicInfoService, BidSchdulHistManageService g2BSchdulHistManageService) {
		super(g2BCmmnService, publicWebClient, prcrmntCorpBasicInfoService);
	}
