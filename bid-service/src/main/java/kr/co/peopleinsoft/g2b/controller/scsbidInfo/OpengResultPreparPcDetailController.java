...
public class OpengResultPreparPcDetailController {
	...
	@GetMapping("/saveStepOpengResultPreparPcDetailInfo")
	public ResponseEntity<String> saveStepOpengResultPreparPcDetailInfo() throws ExecutionException, InterruptedException {
