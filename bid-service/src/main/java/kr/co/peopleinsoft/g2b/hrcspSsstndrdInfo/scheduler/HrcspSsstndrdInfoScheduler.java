...
public class HrcspSsstndrdInfoScheduler {
	...
	public ResponseEntity<String> CollectionLastFiveYearDataJob() throws SchedulerException, JsonProcessingException {
		...
		cmmnScheduleManager.createCronJob(CollectionLastFiveYearDataJob.class, "CollectionLastFiveYearDataJob", "HrcspSsstndrdInfoService", "최근 몇년간의 사전규격 데이터 수집", "0 0 20 * * ?", new HashMap<>());
