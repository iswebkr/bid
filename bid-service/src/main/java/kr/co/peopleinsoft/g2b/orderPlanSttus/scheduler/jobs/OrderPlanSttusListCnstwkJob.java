...
public class OrderPlanSttusListCnstwkJob extends OrderPlanSttusController implements Job {

	public OrderPlanSttusListCnstwkJob(OrderPlanSttusService orderPlanSttusService) {
