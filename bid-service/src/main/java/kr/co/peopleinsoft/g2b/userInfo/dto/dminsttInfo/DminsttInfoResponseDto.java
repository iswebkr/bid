...
@Getter
@Setter
public class DminsttInfoResponseDto extends BidResponseDto implements Serializable {
	@Serial
	private static final long serialVersionUID = 1L;

	private BidResponse<DminsttInfoDto> response;

	public List<DminsttInfoDto> getItems() {
		if (response != null) {
