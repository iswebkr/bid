...
public class OpengResultListInfoScheduler {
	...
	public ResponseEntity<String> CollectionLastFiveYearDataJob() throws SchedulerException, JsonProcessingException {
		...
		cmmnScheduleManager.createCronJob(CollectionLastFiveYearDataJob.class, "CollectionLastFiveYearDataJob", "opengResultListInfo", "최근 몇년간의 개찰결과 데이터 수집", "0 0 22 * * ?", new HashMap<>());
