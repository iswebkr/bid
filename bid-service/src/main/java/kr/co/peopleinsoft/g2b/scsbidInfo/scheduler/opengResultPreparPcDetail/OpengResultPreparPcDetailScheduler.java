...
public class OpengResultPreparPcDetailScheduler {
	...
	public ResponseEntity<String> CollectionLastFiveYearDataJob() throws SchedulerException, JsonProcessingException {
		...
		cmmnScheduleManager.createCronJob(CollectionLastFiveYearDataJob.class, "CollectionLastFiveYearDataJob", "opengResultPreparPcDetail", "최근 몇년간의 예비가격 상세 데이터 수집", "0 0 19 * * ?", new HashMap<>());
