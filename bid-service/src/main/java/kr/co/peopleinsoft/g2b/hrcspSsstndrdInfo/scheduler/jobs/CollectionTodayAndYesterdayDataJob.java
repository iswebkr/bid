...
public class CollectionTodayAndYesterdayDataJob extends HrcspSsstndrdInfoController implements Job {

	public CollectionTodayAndYesterdayDataJob(HrcspSsstndrdInfoService hrcspSsstndrdInfoService) {
