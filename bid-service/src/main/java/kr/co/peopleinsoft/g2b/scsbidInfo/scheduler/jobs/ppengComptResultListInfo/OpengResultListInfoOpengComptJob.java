...
public class OpengResultListInfoOpengComptJob extends OpengComptResultListInfoController implements Job {
	...
	public OpengResultListInfoOpengComptJob(WebClient publicWebClient, AsyncTaskExecutor asyncTaskExecutor, G2BCmmnService g2BCmmnService, OpengComptResultListInfoService opengComptResultListInfoService) {
