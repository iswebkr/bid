...
public class ColctLatestOpengResultListInfoOpengComptJob extends OpengComptResultListInfoController implements Job {
	...
	public ColctLatestOpengResultListInfoOpengComptJob(WebClient publicWebClient, G2BCmmnService g2BCmmnService, OpengComptResultListInfoService opengComptResultListInfoService) {
