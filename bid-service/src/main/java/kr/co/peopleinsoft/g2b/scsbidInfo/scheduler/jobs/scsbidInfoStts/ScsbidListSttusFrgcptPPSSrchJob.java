...
public class ScsbidListSttusFrgcptPPSSrchJob extends ScsbidInfoSttsController implements Job {
	...
	public ScsbidListSttusFrgcptPPSSrchJob(WebClient publicWebClient, AsyncTaskExecutor asyncTaskExecutor, G2BCmmnService g2BCmmnService, ScsbidInfoSttsService scsbidInfoSttsService) {
