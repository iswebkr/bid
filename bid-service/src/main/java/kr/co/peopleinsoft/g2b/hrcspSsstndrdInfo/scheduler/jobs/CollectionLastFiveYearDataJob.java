...
public class CollectionLastFiveYearDataJob extends HrcspSsstndrdInfoController implements Job {

	public CollectionLastFiveYearDataJob(HrcspSsstndrdInfoService hrcspSsstndrdInfoService) {
