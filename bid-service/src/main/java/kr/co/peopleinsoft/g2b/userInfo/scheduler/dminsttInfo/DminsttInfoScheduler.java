...
public class DminsttInfoScheduler {
	...
	public ResponseEntity<String> CollectionLastFiveYearDataJob() throws SchedulerException, JsonProcessingException {
		...
		cmmnScheduleManager.createCronJob(CollectionLastFiveYearDataJob.class, "CollectionLastFiveYearDataJob", "dminsttInfoService", "최근 몇년간의 수요기관 정보 조회", "0 0 23 * * ?", new HashMap<>());
