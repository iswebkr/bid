...
public class OrderPlanSttusScheduler {
	...
	public ResponseEntity<String> CollectionLastFiveYearDataJob() throws SchedulerException, JsonProcessingException {
		...
		cmmnScheduleManager.createCronJob(CollectionLastFiveYearDataJob.class, "CollectionLastFiveYearDataJob", "OrderPlanSttusService", "최근 몇년간의 발주계획 데이터 수집", "0 0 21 * * ?", new HashMap<>());
