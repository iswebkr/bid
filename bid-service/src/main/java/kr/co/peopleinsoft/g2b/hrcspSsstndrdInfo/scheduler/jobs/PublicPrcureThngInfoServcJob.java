...
public class PublicPrcureThngInfoServcJob extends HrcspSsstndrdInfoController implements Job {

	public PublicPrcureThngInfoServcJob(HrcspSsstndrdInfoService hrcspSsstndrdInfoService) {
