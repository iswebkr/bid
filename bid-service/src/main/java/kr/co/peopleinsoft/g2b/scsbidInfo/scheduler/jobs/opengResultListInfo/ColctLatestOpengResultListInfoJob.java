...
public class ColctLatestOpengResultListInfoJob extends OpengResultListInfoController implements Job {
	...
	public ColctLatestOpengResultListInfoJob(WebClient publicWebClient, G2BCmmnService g2BCmmnService, OpengResultListInfoService opengResultListInfoService) {
