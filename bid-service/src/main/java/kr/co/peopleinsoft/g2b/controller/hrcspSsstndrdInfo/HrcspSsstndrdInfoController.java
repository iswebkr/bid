package kr.co.peopleinsoft.g2b.controller.hrcspSsstndrdInfo;
...
import kr.co.peopleinsoft.g2b.dto.hrcspSsstndrdInfo.HrcspSsstndrdInfoRequestDto;
...
public class HrcspSsstndrdInfoController extends CmmnAbstractController {
	...
	@GetMapping("/saveStepHrcspSsstndrdInfo")
	public ResponseEntity<String> saveStepHrcspSsstndrdInfo() throws Exception {
