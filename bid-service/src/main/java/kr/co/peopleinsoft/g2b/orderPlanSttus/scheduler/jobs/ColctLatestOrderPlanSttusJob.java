...
public class ColctLatestOrderPlanSttusJob extends OrderPlanSttusController implements Job {

	public ColctLatestOrderPlanSttusJob(WebClient publicWebClient, AsyncTaskExecutor asyncTaskExecutor, G2BCmmnService g2BCmmnService, OrderPlanSttusService orderPlanSttusService) {
		super(publicWebClient, asyncTaskExecutor, g2BCmmnService, orderPlanSttusService);
	}

	@Override
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		colctThisYearOrderPlanSttus();
	}
}