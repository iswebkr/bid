...
import kr.co.peopleinsoft.g2b.dto.scsbidInfo.scsbidListSttus.ScsbidListSttusDto;
...
public class ScsbidInfoSttsService extends G2BAbstractBidService {
	...
	public <T extends BidRequestDto> int batchInsertScsbidListSttus(URI uri, int pageNo, T requestDto) throws Exception {
		int rowCnt = 0;
